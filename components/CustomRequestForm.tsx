        ...
        <section className={`formAccordionSection ${openSection === 3 ? "isOpen" : ""}`}>
          ...
          <div className="formAccordionBody" hidden={openSection !== 3}>
            ...
            {delivery === "Shipping" || delivery === "Local delivery" ? <div className="shippingAddressPanel">
              ...
              <span className="fieldHelp">{delivery === "Local delivery" ? "Used for local delivery planning and accurate sales-tax calculations." : "We ship within the United States. This is used for fulfillment, shipping, and applicable sales-tax calculations."}</span>
            </div> : null}
